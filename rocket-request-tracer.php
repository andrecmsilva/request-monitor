 ...
 * Description: Bounded WordPress request snapshots with root-cause analysis for PHP callbacks, SQL, HTTP dependencies, fingerprints, and WP-CLI control.
 * Version: 0.7.0
 * Author: Internal Diagnostics
 */
if (!defined('ABSPATH')) exit;

define('REQUEST_MONITOR_VERSION','0.7.0');
...
// Idle frontend fast-path. No diagnostic modules are loaded outside a capture window.
...
require_once REQUEST_MONITOR_DIR.'includes/class-request-monitor-analyzer.php';
...
if($rrt_is_admin){require_once REQUEST_MONITOR_DIR.'includes/class-request-monitor-admin.php';Request_Monitor_Admin::instance();}
if($rrt_is_cli){require_once REQUEST_MONITOR_DIR.'includes/class-request-monitor-cli.php';Request_Monitor_CLI::register();}
